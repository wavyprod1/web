  ...
  <section id="testimonianze" class="testimonials-section surface-ground px-4 py-8 md:px-6 lg:px-8">
    <div class="section-content-container mx-auto">
      <div class="text-center mb-6">
        <h2 class="text-4xl font-bold mb-3">Dicono di Me</h2>
      </div>
            ...
            <Card class="flex flex-column h-full shadow-2 border-round">
              ...
              <template #footer>
                <div class="text-right">
                  ...
                  <p v-if="slotProps.data.authorTitle" class="text-sm text-color-secondary m-0">
                    {{ slotProps.data.authorTitle }}
                  </p>
                </div>
              </template>
            </Card>
...
:deep(.p-carousel .p-carousel-next) {
  align-self: center;
  background-color: var(--p-surface-card-transparent);
  border-radius: 50%;
